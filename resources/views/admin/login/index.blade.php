        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <form action="{{ route('login-post') }}" method="POST" class="md-float-material form-material">
                        @csrf
                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                ...
                                <div style="display: flex; justify-content: center;">
                                    <h5>I have not any account?</h5>
                                    <a href="{{ route('register') }}" style="text-decoration: none; color: #007bff; font-weight: bold; font-size: 16px;">&nbsp;Register</a>
                                </div>                                
                                <hr />
                                <div class="row">
                                    <div class="col-md-10">
